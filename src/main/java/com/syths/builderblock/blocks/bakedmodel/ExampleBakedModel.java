...
//	
//	public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(BuilderBlock.modId + ":bakedmodelblock");
//	
...
//		this.format = format;
//		sprite = bakedTextureGetter.apply(new ResourceLocation(BuilderBlock.modId, "blocks/isbmtexture"));
//	}
//	
